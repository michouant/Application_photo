...
public class Liste_Photo extends BaseAdapter{
        ...
        public Liste_Photo(Context context, ArrayList<Photo> myList) {
            this.myList = myList;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                mViewHolder.textViewAge = (TextView) convertView.findViewById(R.id.textViewDate);
            ...
            mViewHolder.textViewAge.setText(listItem.getDate());
